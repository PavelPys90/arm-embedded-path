...
% Slide 3: RCC_CFGR Register Details
...
% Slide 6: Step 3 - Wait for Switch
...
% Slide 7: Step 4 - Configure Prescalers
...
% Slide 8: Clock Tree Visualization
\begin{frame}{Practice}{Clock Distribution After Configuration}
	...
	\footnotetext[1]{Timer rule: APBx prescaler=1 → Timer=APBx; prescaler>1 → Timer=APBx*2}
\end{frame}

% Slide 9: Complete Function Analysis
...
% Slide 10: When to Use HSI vs HSE vs PLL
